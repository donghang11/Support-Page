...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <br />
                <asp:TextBox ID="detailmodel_cord" runat="server" TextMode="SingleLine" Width="200" ReadOnly="false" AutoPostBack="true" OnTextChanged="detailmodel_cord_TextChanged" CssClass="form-control"></asp:TextBox>
                <br />
            </td>
        </tr>
        <%-- name --%>
        <tr>
            ...
            <td>
                <br />
                <asp:TextBox ID="detailmodel_name" runat="server" TextMode="SingleLine" Width="500" ReadOnly="false" AutoPostBack="true" OnTextChanged="detailmodel_name_TextChanged" CssClass="form-control"></asp:TextBox>
                <br />               
            </td>
        </tr>
    </table>
