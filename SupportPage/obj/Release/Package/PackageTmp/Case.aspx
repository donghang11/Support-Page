<%@ Page Title="Cases" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="Case.aspx.cs" Inherits="SupportPage.Case" EnableEventValidation="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:CheckBox ID="Default_checkbox_show_only_unclosed" runat="server"  Font-Bold="True" Font-Size="Large" ForeColor="#008CBA" Text="<%$ Resources:Case, showonly%>" OnCheckedChanged="Default_checkbox_show_only_unclosed_CheckedChanged" AutoPostBack="True" />
    <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Support %>"
            SelectCommand="
                           with cte(id, 
                            ...
                            cuscom,
                            dispname,
                            CONVERT (varchar(20), DATEDIFF(SECOND, '2050-1-1', reportdate), 20)  + description
                            from Incident a 
                            ...
                            cuscom,
                            dispname,
							sort from cte order by sort "></asp:SqlDataSource>
    </div>
</asp:Content>
