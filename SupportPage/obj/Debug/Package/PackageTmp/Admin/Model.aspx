...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:GridView ID="model_gridview" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover "  AllowPaging="True" AllowSorting="True" DataKeyNames="id" DataSourceID="ModelDataSource" OnRowCommand="Model_gridview_RowCommand" OnRowDataBound="Model_gridview_RowDataBound">
            <Columns>
