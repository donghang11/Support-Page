        ...
        <tr>
            <td>
                ...
                <asp:DropDownList ID="detailcase2_interface" AutoPostBack="true" runat="server" CssClass="select" ForeColor="Blue" BorderStyle="None" OnSelectedIndexChanged="detailcase2_interface_SelectedIndexChanged">
                    ...
                    <asp:ListItem Text="Any" Value="9"></asp:ListItem>
                </asp:DropDownList>
            </td>
            <td>
                <%-- cord --%>
        ...
        <tr>
            <td>
                ...
                <div id="detailcase2_solution" style="text-align: justify; text-justify: auto">
                    ...
                    <asp:ImageButton ID="detailcase2_addsolution" CssClass="btn btn-primary" runat="server" BackColor="Transparent" BorderStyle="None" ImageUrl="~/Images/plus_mark2.png" AlternateText="ADD" OnClick="detailcase2_addsolution_Click" OnClientClick="document.forms[0].target = '_blank'" />
                </div>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="ActionDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:Support%>"
                    SelectCommand="SELECT id, description FROM Action a WHERE a.incident = @id">
                    <SelectParameters>
